...
from hooks import PersitenceHook
...
def parse_args():
    ...
    parser.add_argument("--track", type=lambda x: bool(strtobool(x)),
                        ...
                        help="if toggled, this experiment will be tracked with"
                        " Weights and Biases")
    ...
    parser.add_argument("--anneal-lr", type=lambda x: bool(strtobool(x)),
                        default=True, nargs="?", const=True,
                        help="Toggle learning rate annealing for policy and "
                        "value networks")
    ...
    parser.add_argument("--save-every", type=int, default=128*10,
                        help="save the agent every n steps")
...
if __name__ == "__main__":
    ...
    error_msg = "only discrete action space is supported"
    assert isinstance(envs.single_action_space, gym.spaces.Discrete), error_msg
    ...
    for update in range(1, num_updates + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if args.clip_vloss:
                    ...
                    v_loss = .5 * ((newvalue - b_returns[mb_inds]) ** 2).mean()
        ...
        if global_step % args.save_every == 0:
            ...
            population.commit(
                ...
                hyperparameters={key: value for key, value
                                 in vars(args).items()},
